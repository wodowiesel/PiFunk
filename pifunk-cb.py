...
# case [10]:  freq=27.075 #antennenabgleich
...
# Diese Kanäle sind in den meisten Ländern nicht für CB-Funk zugelassen. Allerdings werden sie in einigen Ländern, darunter auch Deutschland[3], für andere Zwecke wie z. B. Funkfernsteuerungen, Babyphones, kabellose Tastaturen und Mäuse u. ä. verwendet.
...
# case [11]:  freq=27.085 #freigegeben zur Zusammenschaltung mehrerer CB-Funkgeräte über eine Internetverbindung in Deutschland
# case [12]:  freq=27.105 
# case [13]:  freq=27.115 
...
# case [17]:  freq=27.165 #Kanal wird von dänischen Schwertransportfahrern in Deutschland und Dänemark benutzt.
# case [18]:  freq=27.175
...
# case [20]:  freq=27.205 #zum Antennenabgleich genutzte Mitte bei 40-Kanal-Geräten, wird in Österreich sehr oft für Schwertransportfahrten benutzt

##40ch devices
# case [21]:  freq=27.215 #türkischer Anrufkanal in Deutschland und Europa (FM)	
# case [22]:  freq=27.225 #oft von Walkie-Talkies genutzt, auch von Babyfonen genutzt, wird auch als Anrufkanal für rumänische Fernlastfahrer verwendet
# case [23]:  freq=27.255 #Die Kanäle 23, 24, 25 sind sog. Dreher, sie folgen nicht dem aufsteigenden 10-kHz-Raster	
# case [24]:  freq=27.235 #Datenkanal (D)
# case [25]:  freq=27.245 #Datenkanal (D), USB ROS Intern.	
# case [26]:  freq=27.265 
# case [27]:  freq=27.275 
# case [28]:  freq=27.285 #Kanal wird von polnischen Fernfahrern in Deutschland benutzt, Anrufkanal in Polen, wobei allgemein die CB-Kanalfrequenz in Polen um 5 kHz niedriger ist.
# case [29]:  freq=27.295#Freigegeben zur Zusammenschaltung mehrerer CB-Funkgeräte über eine Internetverbindung in Deutschland	
...
# case [32]:  freq=27.325 
# case [33]:  freq=27.335 
# case [34]:  freq=27.345 #freigegeben zur Zusammenschaltung mehrerer CB-Funkgeräte über eine Internetverbindung in Deutschland
# case [35]:  freq=27.355 #öffentlicher Kanal
# case [36]:  freq=27.365 #Datenkanal USB ROS international
# case [37]:  freq=27.375 #Gateway-Kanal Österreich, FM	
# case [38]:  freq=27.385 #inoffizieller internationaler DX-Kanal (LSB)
# case [39]:  freq=27.395 #Freigegeben zur Zusammenschaltung mehrerer CB-Funkgeräte über eine Internetverbindung in Deutschland	
# case [40]:  freq=27.405 #ab März 2016 freigegeben zur Zusammenschaltung mehrerer CB-Funkgeräte über eine Internetverbindung in Deutschland (FM/AM/SSB in D)
...
# case [41]:  freq=27.565 #Ab März 2016 Freigegeben zur Zusammenschaltung mehrerer CB-Funkgeräte über eine Internetverbindung in Deutschland (FM),inoffizieller DX-Kanal (FM)
...
# case [61]:  freq=26.765 #Freigegeben zur „Zusammenschaltung mehrerer CB-Funkgeräte über eine Internetverbindung“ in Deutschland	
# case [62]:  freq=26.775
# case [63]:  freq=26.785	
# case [64]:  freq=26.795
# case [65]:  freq=26.805
...
# case [69]:  freq=26.845
# case [70]:  freq=26.855
# case [71]:  freq=26.865 #Freigegeben zur „Zusammenschaltung mehrerer CB-Funkgeräte über eine Internetverbindung“ in Deutschland	
# case [72]:  freq=26.875
# case [73]:  freq=26.885
# case [74]:  freq=26.895
# case [75]:  freq=26.905
